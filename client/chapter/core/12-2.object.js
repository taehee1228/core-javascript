...
// 데이터 구조 설계 3 depth 이상

const combiCssMap = Object.assign({},cssMapA,cssMapB)
const spreadCssMap = {...cssMapA, ...cssMapB,headers:{...cssMapA.header, ...cssMapB.header}}
